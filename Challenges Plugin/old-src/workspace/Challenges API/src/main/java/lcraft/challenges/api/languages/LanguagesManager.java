...
import lcraft.challenges.api.languages.impl.English;
import lcraft.challenges.api.languages.impl.German;
...
public class LanguagesManager {
    ...
    private static Config userCFG, cfg;

    public LanguagesManager(ChallengesApi plugin) {
        langs = new ArrayList<>();
        userCFG = new Config("lang", "users.yml");
        cfg = new Config("lang", "config.yml");
    ...
    public static Config getUserCFG() {
        return userCFG;
    }
    ...
    public Language getPlayer(UUID player) {
    ...
    public static ArrayList<Language> getLangList() {
        return langs;
    }
